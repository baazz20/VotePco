...
<body class="g-sidenav-show   bg-gray-100">
    <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-left ms-3 bg-white" id="sidenav-main" data-color="info">
        ...
        <div class="collapse navbar-collapse  w-auto" id="sidenav-collapse-main">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link  active" href="candidat.php">
                        <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
    ...
    <main class="main-content mt-1 border-radius-lg">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="email" value="candidat@email.com" id="example-text-input" name="email">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="tel" value="+2550707070707" id="example-text-input" name="phone">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="mb-0">
                                            <span class="border-0 d-flex align-items-center px-0 mb-2">
                                                ...
                                                <div class="d-flex align-items-start flex-column justify-content-center">
                                                    <h6 class="mb-0 text-sm">
                                                        <label for="file-ip-1" class="btn btn-link pe-3 ps-0 ms-auto">Cliquer ici pour ajouter la photo du candidat</label>
                                                        <input style="display:none;" type="file" class="form-control" name="photoCandidat" id="file-ip-1" accept="image/*" onchange="showPreview(event);">
                                                    </h6>
                                                </div>
        ...
        <div class="container-fluid py-4">
            <div class="row">
                <div class="col-sm-6">
                    <h2>Gestion des <b>Candidats</b></h2>
                </div>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex px-2 py-1">
                                                        ...
                                                        <div class="d-flex flex-column justify-content-center">
                                                            <h6 class="mb-0 text-sm"><?php echo $row['name']; ?>
                                                ...
                                                <td>
                                                    ...
                                                    <p class="text-xs text-secondary mb-0"> candidat au poste de PCO
                                                    </p>
                                                </td>
                                                <td class="align-middle text-center text-sm">
                                                    <span class="badge badge-sm bg-gradient-success"><?php echo $row['phone']; ?></span>
                                                </td>
            ...
            <div class="row align-items-center justify-content-lg-between">
                <div class="col-lg-6 mb-lg-0 mb-4">
                    <div class="copyright text-center text-sm text-muted text-lg-left">
                        ...
                        <a href="https://www.creative-tim.com" class="font-weight-bold" target="_blank">Equipe DEV JI-2022</a>
                ...
                <div class="col-lg-6">
                    <ul class="nav nav-footer justify-content-center justify-content-lg-end">
                        <li class="nav-item">
                            <a href="https://www.creative-tim.com" class="nav-link text-muted" target="_blank">MIAGE-GI</a>
                        </li>
                        <li class="nav-item">
