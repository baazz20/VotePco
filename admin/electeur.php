        ...
        <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl position-sticky blur shadow-blur mt-4 left-auto top-1 z-index-sticky" id="navbarBlur" navbar-scroll="true">
            <div class="container-fluid py-1 px-3">
                <nav aria-label="breadcrumb">
                    ...
                    <h6 class="font-weight-bolder mb-0">GESTION DES ELECTEURS</h6>
                </nav>
            ...
            <div class="modal-dialog modal-dialog-centered" style="max-width: 40%;" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form role="form text-left" action="backend/saveElect.php" method="POST" enctype="multipart/form-data">
                            <section>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="text" value="Snow" id="example-text-input" name="name">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="example-text-input" class="form-control-label">Prenom</label>
                                            <input class="form-control" type="text" value="John" id="example-text-input" name="lastname">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="email" value="electeur@email.com" id="example-text-input" name="email">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                            ...
                                            <span class="border-0 d-flex align-items-center px-0 mb-2">
                                                ...
                                                <div class="d-flex align-items-start flex-column justify-content-center">
                                                    <h6 class="mb-0 text-sm">
                                                        <label for="file-ip-1" class="btn btn-link pe-3 ps-0 ms-auto">Cliquer ici pour ajouter la photo d'electeur</label>
                                                        <input style="display:none;" type="file" class="form-control" name="photoElecteur" id="file-ip-1" accept="image/*" onchange="showPreview(event);">
                                                    </h6>
                                                </div>
...
<!-- edit modal -->
        <div class="modal fade" id="exampleeditModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" style="max-width: 40%;" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">Editer un Candidat</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
        ...
        <div class="container-fluid py-4">
            <div class="row">
                <div class="col-sm-6">
                    <h2>Gestion des <b>Electeurs</b></h2>
                </div>
                    ...
                    <div class="card">
                        <div class="card-body p-3">
                            <div class="row">
                                <div class="col-8">
                                    <div class="numbers">
                                        <p class="text-sm mb-0 text-capitalize font-weight-bold">Nouveau Candidat</p>

                                    </div>
                                </div>
                                <div class="col-4 text-end">
                                    <div class="icon icon-shape bg-gradient-primary shadow text-center border-radius-md">
                                        <a type="button" class="hidden" data-bs-toggle="modal" data-bs-target="#exampleModal">
                                            <i class="fa fa-plus text-lg opacity-10" aria-hidden="true"> </i></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card">
                        <div class="card-body p-3">
                            <div class="row">
                                <div class="col-8">
                                    <div class="numbers">
                                        <p class="text-sm mb-0 text-capitalize font-weight-bold">Total electeur</p>
                                        <h5 class="font-weight-bolder mb-0">
                                            <?php
                                            $ret = mysqli_query($conn, "select * from votant");
                                            $cnt = 0;
                                            ...
                                            <span class="text-success text-sm font-weight-bolder">Electeur (s)</span>
                                        </h5>
                                    </div>
                                </div>
                                <div class="col-4 text-end">
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex px-2 py-1">
                                                        <div>
                                                            <img src="assets/uploads/picture/<?php echo $row['photo']; ?>" class="avatar avatar-sm me-3">
                                                        </div>
                                                        <div class="d-flex flex-column justify-content-center">
                                                ...
                                                <td>
                                                    ...
                                                    <p class="text-xs text-secondary mb-0"> Electeur 
                                                    </p>
                                                </td>
                                                <td class="align-middle text-center text-sm">
                                                    <span class="badge badge-sm bg-gradient-success"><?php echo $row['CodeVote']; ?></span>
                                                </td>
                                                ...
                                                <td class="align-middle">
                                                    ...
                                                    <a href="backend/edit.php?id=<?php echo $row['IDVOTANT']?>" class="text-secondary font-weight-bold text-xs" data-toggle="tooltip" data-original-title="Edit user">
                                                    <i class="fas fa-user-edit" type="button"  data-bs-toggle="modal" data-bs-target="#exampleeditModal"></i>&emsp;
                                                    </a>
                                                    <a href="backend/supprimerElecteur.php?idF=<?php echo $row['IDVOTANT']?>" class="text-secondary font-weight-bold text-xs" onclick="return confirm('Voulez vous vraiment le suprimer ?');" class="text-secondary font-weight-bold text-xs" data-toggle="tooltip" data-original-title="Edit user">
